...
public class ControllerCadastroContato implements Listeners, ItemListener {
	...
	public ControllerCadastroContato() {
		contatos = new ArrayList<>();
	}

	@Override
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == internalCadastroContato.getBtnNovoContato()) {
	...
	public void itemStateChanged(ItemEvent e) {
		...
		internalCadastroContato.getBtnNovoContato().setVisible(true);
	...
	public void addListeners() {
		internalCadastroContato.getBtnNovoContato().addActionListener(this);
